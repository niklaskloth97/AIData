...
from restapi.routes import mappings, caseIds, process, additional_events, projectTables, projectTableColumns, script_generation, scripts, possible_mappings
...
root_router.include_router(possible_mappings.router)
